...
namespace ACWebApp.Controllers
{
    public class IdeasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,IdeaTitle,IdeaDescription,IdeaPros,IdeaCons")] Idea idea)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdeaTitle,IdeaDescription,IdeaPros,IdeaCons")] Idea idea)
        {
            if (id != idea.Id)
            {
                return NotFound();
